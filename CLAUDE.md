...
- **En progreso**: **Epic 2 · Membresías y facturación** — `E2-01` (entidades `Plan`/`Membership`), `E2-02` (integración con Mercado Pago, modelo Marketplace/OAuth), `E2-03` (webhook idempotente y con firma verificada) y `E2-04` (cancelación "hasta fin de período", cron diario) completos. Falta `E2-05` (dunning), `E2-06` (registro de facturas) y `E2-07` (gestión de plan/tarjeta sin UI propia).
