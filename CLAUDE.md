...
- **Siguiente en el roadmap**: Epic 4 (Operación del gimnasio) → Epic 5 (Observabilidad). Eso cierra **SmartBox v1.0**.
...
1. Epic 2 (facturación) y Epic 3 (reservas) ya tienen sus decisiones de alcance cerradas (ver arriba) — trial, cancelación, reembolsos, dunning, modelo de horarios recurrentes y estados de `Reservation` están resueltos. No los reabras sin avisar; si aparece un caso no cubierto, es una historia nueva, no una reinterpretación de lo ya decidido.
