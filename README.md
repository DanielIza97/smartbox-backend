...
Pagos/IoT del documento de arquitectura original siguen sin implementar (Pagos ya resuelto vía Epic 2/Mercado Pago) — IoT en particular es la última release del roadmap ("SmartBox IoT"), no la primera. Ver el documento oficial (arriba) para el detalle completo de cada épica, los sprints y las decisiones de alcance ya tomadas.
